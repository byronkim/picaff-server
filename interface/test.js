...
exports.default = {
    resultCoffee: (coffeeScore) => {
        const coffeeResultScore = [0, 0, 0, 0, 0];
        ...
        for (let i = 0; i < coffeeResultScore.length; i++) {
            if (coffeeResultScore[index] < coffeeResultScore[i])
                index = i;
        }
        return index + 1;
    },
    resultProduct: (productScore) => {
        const productResultScore = [0, 0, 0, 0];
        ...
        for (let i = 0; i < productResultScore.length; i++) {
            if (productResultScore[index] < productResultScore[i])
                index = i;
        }
        return index + 6;
    }
